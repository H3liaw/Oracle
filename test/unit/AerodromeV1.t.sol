...
import "../../src/adapters/AerodromeV1.sol";
...
import { AerodromeBaseAdapter } from "../../src/libs/base/AerodromeBaseAdapter.sol";
...
contract TestAerodromeV1Adapter is Test {
    ...
    function testRevertAddAsset__InvalidAssetDecimals() public {
        AerodromeV1Adapter.AdapterData memory data;
        data.pool = AERO_POOL_DAI_USDC;
        data.baseToken = USDC;
        data.quoteTokenDecimals = 6;
        data.baseTokenDecimals = 6;
        data.granularity = 10;
    ...
    function testRevertAddAsset__InvalidGranularity() public {
        AerodromeV1Adapter.AdapterData memory data;
        data.pool = AERO_POOL_DAI_USDC;
        data.baseToken = USDC;
        data.quoteTokenDecimals = 18;
        ...
        vm.expectRevert(AerodromeBaseAdapter.AerodromeAdapter__InvalidGranularity.selector);
        adapter.addAsset(DAI, data);
    }
