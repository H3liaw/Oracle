...
import { CurveBaseAdapter } from "../libs/base/CurveBaseAdapter.sol";
...
/**
 * @title Curve2PoolAssetAdapter
 * @notice Adapter for Curve V2 pools
 * @dev Provides price data from Curve V2 pools to the SharePriceOracle
 */
