 ...
 */
contract BalancerAdapter is ReentrancyGuard, BaseOracleAdapter {
    /*//////////////////////////////////////////////////////////////
                                TYPES
    //////////////////////////////////////////////////////////////*/
    ...
    /// @notice Whether to enable reentrancy checks
    bool internal _reentrancyCheckEnabled = true;
    ...
    error BalancerAdapter__ReentrancyDetected();
    /*//////////////////////////////////////////////////////////////
                              CONSTRUCTOR
    //////////////////////////////////////////////////////////////*/
     ...
     */
    function addAsset(address asset, bytes32 poolId, address quoteToken, uint256 heartbeat, bool inUSD) external {
        ...
        returns (ISharePriceOracle.PriceReturnData memory pData)
    {
        ...
        // For weighted pools, the spot price is: spotPrice = ((balanceQuote * assetWeight) / (balanceAsset *
        // quoteWeight)
