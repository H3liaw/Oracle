...
/**
 * @title AerodromeV2Adapter
 * @notice Adapter for Aerodrome V2 pools
 * @dev Provides price data from Aerodrome V2 pools to the SharePriceOracle
 */
contract AerodromeV2Adapter is AerodromeBaseAdapter {
    ...
    /// @notice Checks if the pool is an Aerodrome V2 pool
    /// @param pool The address of the pool to check
    /// @return True if the pool is an Aerodrome V2 pool, false otherwise
