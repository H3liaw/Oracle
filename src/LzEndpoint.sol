...
/**
 * @title LzEndpoint
 * @notice A contract that allows for sending and receiving share prices via LayerZero
 * @dev This contract is used to send and receive share prices via LayerZero
 */
contract LzEndpoint is ILayerZeroReceiver, Ownable {
    ...
    /// @notice Enforced option parameter
    ...
    /// @param endpoint_ The new LayerZero endpoint address
    ...
    /// @notice Sets the peer for an endpoint
    /// @param eid_ The endpoint ID
    /// @param peer_ The peer address
    /// @dev Only callable by the owner
    ...
    /// @param params The enforced option parameters
    /// @dev Only callable by the owner
    ...
    /// @notice Requests share prices from a destination chain
    /// @param dstEid The destination endpoint ID
    /// @param vaultAddresses The vault addresses
    /// @param options The options
